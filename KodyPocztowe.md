...
Do tego przydałoby się to jakoś zaimportować.Niestety XPO nie nadaje sie do tego najlepiej - zdecydowanie lepiej byloby zaimportowac to jakims narzedziem z bazy danych.
Tu zastosowałem metodę sugerowaną przez ekipe od XPO aby proces importu podzielić na partie po kilka tysięcy rekordów i od nowa budować UnitOfWork:
...
public class KodyPocztoweImporter : CSVImporter
   {
       ...
       public override void ImportRow(CsvRow csv)
       {
           ...
           // Ważne w przypadku importu dużej ilości danych
           // NIestety XPO nie nadaje sie do tego najlepiej - zdecydowanie lepiej byloby zaimportowac to jakims narzedziem z bazy danych.
           // Tu zastosowana jest metoda sugerowana przez ekipe od XPO aby proces importu podzielić na partie po kilka tysięcy rekordów i od nowa budować UnitOfWork
           if (rowCnt % 10000 == 0)
           {
